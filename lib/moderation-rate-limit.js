const DEFAULT_POLICIES = Object.freeze({
  ...
  'message-duplicate': { limit: 4, windowSeconds: 30, escalationSeconds: [8, 30, 120] },
  ...
  'chat-request': { limit: 6, windowSeconds: 60, escalationSeconds: [30, 120, 600] },
  'chat-request-response': { limit: 12, windowSeconds: 60, escalationSeconds: [30, 120, 600] },
  'chat-request-cancel': { limit: 12, windowSeconds: 60, escalationSeconds: [30, 120, 600] },
  'direct-chat-resume': { limit: 12, windowSeconds: 60, escalationSeconds: [15, 60, 300] },
  'conversation-delete-unsaved': { limit: 3, windowSeconds: 3_600, escalationSeconds: [60, 300, 900] },
